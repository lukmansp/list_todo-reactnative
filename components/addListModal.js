...
export default class addListModal extends React.Component {
    backgroundColors = ["#5cd859", "#24a6d9", "#595bd9", "#8822d9", "#d159d8", "#d85963", "#d88559"]
    state = {
        name: '',
    ...
    render() {
        return (
            <KeyboardAvoidingView style={styles.container} behavior="padding">
                <TouchableOpacity style={{ position: 'absolute', top: '5%', right: 32 }} onPress={this.props.closeModal}>
